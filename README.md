...
**Back-end Rails** Is a Rails app that serves data from a PostgreSQL database to [this](https://github.com/Bleu-Yves-Sopoude/hello-react-front-end) React frontend App in JSON format through an API endpoint.
...
```sh
  git clone https://github.com/Bleu-Yves-Sopoude/hello-rails-back-end.git
```
